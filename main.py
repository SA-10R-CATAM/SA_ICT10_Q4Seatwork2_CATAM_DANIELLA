...
class Classmate:
    ...
    def introduce(self):
        return f"Hi(˶>⩊<˶) I am {self.name} ❤︎ from {self.section}.☘︎ ݁˖. My favorite subject is {self.favorite_subject}.ᐟ.ᐟ"


# Store classmates
classmates = [
    Classmate("Yun Jin Huh", "Emerald","English"),
    Classmate("Nam Joon Kim", "Ruby", "Philosophy"),
    Classmate("Juan Miguel", "Ruby", "Math"),
    Classmate("Min Ji Kim", "Amethyst", "PE"),
    Classmate("Ferdie Sangat", "Ruby", "History")
]
